...
public interface HttpMessageConverter<T> {
	...
	/**
	 * Read an object of the given type form the given input outputMessage, and returns it.
	 *
	 * @param clazz				the type of object to return. This type must have previously been passed to the
	 *                     {@link #canRead canRead} method of this interface, which must have returned {@code true}.
	 * @param inputMessage the HTTP input inputMessage to read from
	 * @return the converted object
	 * @throws java.io.IOException in case of I/O errors
	 * @throws org.springframework.http.converter.HttpMessageNotReadableException
	 *                             in case of conversion errors
	 */
	void read(Class<? extends T> clazz, HttpInputMessage inputMessage, Promise<T> promise)
